...
AiAvatarUserModel aiAvatarUserModelFromJson(String str) =>
    AiAvatarUserModel.fromJson(json.decode(str));

class AiAvatarUserModel {
  List<Result>? results;
  Info? info;

  AiAvatarUserModel({this.results, this.info});

  factory AiAvatarUserModel.fromJson(Map<String, dynamic> json) =>
      AiAvatarUserModel(
        results:
            json["results"] == null
                ? []
...
class Dob {
  ...
  factory Dob.fromJson(Map<String, dynamic> json) =>
      Dob(date: json["date"], age: json["age"]);
