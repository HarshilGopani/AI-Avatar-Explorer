...
abstract class Dimens {
  ...
  static double threeHundredten = 310;
  ...
  // static double getHeightPercent(double value) => MediaQuery.of(context).h * value;
  ...
  static EdgeInsets edgeInsetsLeft60 = EdgeInsets.only(left: sixty);

  static EdgeInsets edgeInsetsTopt10 = EdgeInsets.only(top: ten);
  static EdgeInsets edgeInsetsTop5 = EdgeInsets.only(top: five);

  static EdgeInsets edgeInsetsTop16 = EdgeInsets.only(top: sixteen);
  static EdgeInsets edgeInsetsTop20 = EdgeInsets.only(top: twenty);
  static EdgeInsets edgeInsetsTop60 = EdgeInsets.only(top: sixteen);
  static EdgeInsets edgeInsetsTop150 = EdgeInsets.only(top: hundredFifty);

  static EdgeInsets edgeInsetsBottom10 = EdgeInsets.only(bottom: ten);

  static EdgeInsets edgeInsetsBottom5 = EdgeInsets.only(bottom: ten);
  static EdgeInsets edgeInsetsBottom8 = EdgeInsets.only(bottom: eight);
  ...
  static EdgeInsets edgeInsetsRight3 = EdgeInsets.only(right: three);
  ...
  static EdgeInsets edgeInsets20_20_20_20 = EdgeInsets.fromLTRB(
    twenty,
    twenty,
    twenty,
    twenty,
  ...
  static EdgeInsets edgeInsets04_02_04_02 = EdgeInsets.fromLTRB(
    four,
    two,
    four,
    two,
  ...
  static EdgeInsets edgeInsets20_20_20_12 = EdgeInsets.fromLTRB(
    twenty,
    twenty,
    twenty,
    twelve,
  ...
  static EdgeInsets edgeInsets20_14_20_14 = EdgeInsets.fromLTRB(
    twenty,
    fourteen,
    twenty,
    fourteen,
  ...
  static EdgeInsets edgeInsets0_0_12_12 = EdgeInsets.fromLTRB(
    zero,
    zero,
    twelve,
    twelve,
  ...
  static EdgeInsets edgeInsets12_06_12_06 = EdgeInsets.fromLTRB(
    twelve,
    six,
    twelve,
    six,
  ...
  static EdgeInsets edgeInsets20_0_20_30 = EdgeInsets.fromLTRB(
    twenty,
    zero,
    twenty,
    thirty,
  ...
  static EdgeInsets edgeInsets20_0_20_50 = EdgeInsets.fromLTRB(
    twenty,
    zero,
    twenty,
    fifty,
  ...
  static EdgeInsets edgeInsets20_20_20_50 = EdgeInsets.fromLTRB(
    twenty,
    twenty,
    twenty,
    fifty,
  ...
  static EdgeInsets edgeInsets20_20_20_30 = EdgeInsets.fromLTRB(
    twenty,
    twenty,
    twenty,
    thirty,
  ...
  static EdgeInsets edgeInsets20_05_00_05 = EdgeInsets.fromLTRB(
    twenty,
    five,
    zero,
    five,
  ...
  static EdgeInsets edgeInsets20_03_00_03 = EdgeInsets.fromLTRB(
    twenty,
    three,
    zero,
    three,
  ...
  static EdgeInsets edgeInsets00_05_20_05 = EdgeInsets.fromLTRB(
    zero,
    five,
    twenty,
    five,
  ...
  static EdgeInsets edgeInsets6_2_6_2 = EdgeInsets.fromLTRB(six, two, six, two);
  ...
  static EdgeInsets edgeInsets30_16_30_16 = EdgeInsets.fromLTRB(
    thirty,
    sixteen,
    thirty,
    sixteen,
  ...
  static EdgeInsets edgeInsets0_0_12_0 = EdgeInsets.fromLTRB(
    zero,
    zero,
    twelve,
    zero,
  ...
  static EdgeInsets edgeInsets08_04_08_04 = EdgeInsets.fromLTRB(
    eight,
    four,
    eight,
    four,
  ...
  static EdgeInsets edgeInsets50_40_50_40 = EdgeInsets.fromLTRB(
    fifty,
    fourty,
    fifty,
    fourty,
  ...
  static EdgeInsets edgeInsets20_60_20_20 = EdgeInsets.fromLTRB(
    twenty,
    sixty,
    twenty,
    twenty,
  ...
  static EdgeInsets edgeInsets20_50_20_20 = EdgeInsets.fromLTRB(
    twenty,
    fifty,
    twenty,
    twenty,
  ...
  static EdgeInsets edgeInsets20_60_20_00 = EdgeInsets.fromLTRB(
    twenty,
    sixty,
    twenty,
    zero,
  ...
  static EdgeInsets edgeInsets20_60_20_80 = EdgeInsets.fromLTRB(
    twenty,
    sixty,
    twenty,
    eighty,
  ...
  static EdgeInsets edgeInsets14_06_14_06 = EdgeInsets.fromLTRB(
    fourteen,
    six,
    fourteen,
    six,
  ...
  static EdgeInsets edgeInsets10_06_10_06 = EdgeInsets.fromLTRB(
    ten,
    six,
    ten,
    six,
  ...
  static EdgeInsets edgeInsets10_04_10_04 = EdgeInsets.fromLTRB(
    ten,
    four,
    ten,
    four,
  ...
  static EdgeInsets edgeInsets7_0_0_0 = EdgeInsets.only(left: seven);
  ...
  static EdgeInsets edgeInsets13_0_13_0 = EdgeInsets.fromLTRB(
    thirteen,
    zero,
    thirteen,
    zero,
  ...
  static EdgeInsets edgeInsets0_47_0_0 = EdgeInsets.only(top: fourtySeven);

  static EdgeInsets edgeInsets25_0_0_0 = EdgeInsets.only(left: twentyFive);
  ...
  static EdgeInsets edgeInsets0_28_0_0 = EdgeInsets.only(top: twentyEight);
  ...
  static EdgeInsets edgeInsets0_0_0_7 = EdgeInsets.only(right: Dimens.seven);
  ...
  static EdgeInsets edgeInsets0_15_15_0 = EdgeInsets.only(top: ten, right: ten);
  ...
  static EdgeInsets edgeInsets0_25_0_0 = EdgeInsets.only(top: twentyFive);
  ...
  static EdgeInsets edgeInsets0_0_14_0 = EdgeInsets.only(right: fourteen);
  ...
  static EdgeInsets edgeInsets0_10_0_0 = EdgeInsets.only(top: ten);
  ...
  static EdgeInsets edgeInsets0_40_0_0 = EdgeInsets.only(top: fourty);
  static EdgeInsets edgeInsets0_54_0_0 = EdgeInsets.only(top: fiftyFour);
  ...
  static EdgeInsets edgeInsets0_0_0_8 = EdgeInsets.only(bottom: eight);
  ...
  static EdgeInsets edgeInsets14_04_14_04 = EdgeInsets.fromLTRB(
    fourteen,
    four,
    fourteen,
    four,
  ...
  static EdgeInsets edgeInsets0_2_0_0 = EdgeInsets.only(top: two);
  ...
  static EdgeInsets edgeInsets24_15_23_15 = EdgeInsets.only(
    left: twentyFour,
    top: fifteen,
    right: twentyThree,
    bottom: fifteen,
